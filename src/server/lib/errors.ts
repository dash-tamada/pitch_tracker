...
export type ErrorCode =
  | "UNAUTHENTICATED" | "MFA_REQUIRED" | "FORBIDDEN" | "NOT_FOUND" | "VALIDATION"
  ...
  | "CSRF" | "PAYLOAD_TOO_LARGE" | "INTERNAL";

const STATUS: Record<ErrorCode, number> = {
  UNAUTHENTICATED: 401, MFA_REQUIRED: 401, INVALID_CREDENTIALS: 401, FORBIDDEN: 403, CSRF: 403,
  ...
  RATE_LIMITED: 429, ACCOUNT_LOCKED: 423, PAYLOAD_TOO_LARGE: 413, INTERNAL: 500,
};
